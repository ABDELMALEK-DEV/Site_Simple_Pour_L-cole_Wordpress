var tribe = typeof tribe === "object" ? tribe : {}; tribe["events"] = tribe["events"] || {}; tribe["events"]["elements"] =
...
var objectWithoutProperties = __webpack_require__(232);
...
var external_var_wp_element_root_wp_element_ = __webpack_require__(25);
...
var element_Input = function (_Component) {
  ...
  */
	function Input() {
		...
		_this.onChange = function (event) {
			...
			var callback = isFunction_default()(onChange) ? onChange : noop_default.a;
			var completeCallback = isFunction_default()(onComplete) ? onComplete : noop_default.a;

			if (validate) {
				_this.setState({ isValid: _this.validate(event.target.value) }, completeCallback);
				callback(event);
			} else {
				completeCallback();
				callback(event);
		...
		_this.maybeValidate = function (value) {
  ...
  */
   ...
   */
		value: function validate(value) {
			...
			return isFunction_default()(validateCallback) ? validateCallback(value) : this.maybeValidate(value);
		}
   ...
   */
		...
		value: function render() {
			...
			var _props2 = this.props,
			    ...
			    properties = objectWithoutProperties_default()(_props2, ['onComplete', 'required', 'validate']);

			return wp.element.createElement('input', extends_default()({}, properties, {
...
var lodash_unescape = __webpack_require__(434);
...
var querystringify = __webpack_require__(90);

// EXTERNAL MODULE: external {"var":"wp.components","root":["wp","components"]}
var external_var_wp_components_root_wp_components_ = __webpack_require__(14);
...
var terms_list_style = __webpack_require__(586);
...
var getTerms = function getTerms(terms) {
...
var getTermListClassName = function getTermListClassName() {
	var level = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
	return 'tribe-editor__terms__list tribe-editor__terms__list--level-' + level;
};

var getTermListItemClassName = function getTermListItemClassName() {
	var level = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
	return 'tribe-editor__terms__list-item tribe-editor__terms__list-item--level-' + level;
};

var element_termName = function termName() {
	var term = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

	return term.name ? unescape_default()(term.name).trim() : Object(external_var_wp_i18n_root_wp_i18n_["__"])('(Untitled)', 'the-events-calendar');
};
...
var Label = function Label(_ref) {
	...
	return wp.element.createElement(
		'strong',
		{ className: 'tribe-editor__terms__label', key: 'terms-label' },
		text,
		' '
	);
};
...
var Empty = function Empty(_ref2) {
	var _ref2$renderEmpty = _ref2.renderEmpty,
	    renderEmpty = _ref2$renderEmpty === undefined ? null : _ref2$renderEmpty,
	    id = _ref2.id,
	    label = _ref2.label;
	return renderEmpty && wp.element.createElement(
		'div',
		{ key: id, className: 'tribe-editor__terms--empty' },
		wp.element.createElement(Label, { text: label }),
		renderEmpty
	);
};

var List = function List(_ref3) {
	var _ref3$terms = _ref3.terms,
	    terms = _ref3$terms === undefined ? [] : _ref3$terms,
	    _ref3$termSeparator = _ref3.termSeparator,
	    termSeparator = _ref3$termSeparator === undefined ? ', ' : _ref3$termSeparator,
	...
	if (isLoading) {
		return wp.element.createElement(element_Loading, { id: id, className: className });
	}
	...
	return wp.element.createElement(
		...
		terms.map(function (term, index) {
			return wp.element.createElement(Item, {
				key: index,
				term: term,
...
var Separator = function Separator(_ref4) {
	var delimiter = _ref4.delimiter,
	    isLast = _ref4.isLast;
	return !isLast ? wp.element.createElement(
		'span',
		null,
		delimiter
	) : '';
...
var Item = function Item(_ref5) {
	...
	return wp.element.createElement(
		'li',
		{ key: term.id, className: getTermListItemClassName(0) },
		wp.element.createElement(
			...
			element_termName(term)
		),
		wp.element.createElement(Separator, { delimiter: separator, isLast: isLast })
	);
};

var element_Loading = function Loading(_ref6) {
	...
	return wp.element.createElement(
		'div',
		{ key: id, className: 'tribe-editor__terms__spinner ' + className },
		wp.element.createElement(Label, null),
		wp.element.createElement(external_var_wp_components_root_wp_components_["Spinner"], { key: 'terms-spinner' })
	);
};

var element_TaxonomiesElement = function TaxonomiesElement(_ref7) {
	var className = _ref7.className,
	    slug = _ref7.slug,
	    label = _ref7.label,
	    renderEmpty = _ref7.renderEmpty,
	    isRequesting = _ref7.isRequesting,
	    rest = objectWithoutProperties_default()(_ref7, ['className', 'slug', 'label', 'renderEmpty', 'isRequesting']);

	var terms = getTerms(rest.terms);
	var key = 'tribe-terms-' + slug;

	if (!terms.length && !isRequesting) {
		return wp.element.createElement(Empty, { id: key, renderEmpty: renderEmpty, label: label });
	}

	return wp.element.createElement(
		'div',
		{ key: key, className: 'tribe-editor__terms ' + className },
		wp.element.createElement(Label, { text: label }),
		wp.element.createElement(
			'div',
			{ key: 'terms', className: 'tribe-editor__terms__list-wrapper' },
			wp.element.createElement(List, { terms: terms, className: className, id: key, isLoading: isRequesting })
		)
	);
};


element_TaxonomiesElement.defaultProps = {
	termSeparator: Object(external_var_wp_i18n_root_wp_i18n_["__"])(', ', 'the-events-calendar'),
	className: '',
	terms: [],
	isRequesting: false
};

var applySelect = Object(external_var_wp_data_root_wp_data_["withSelect"])(function (select, props) {
	...
	var attributeName = slug === 'post_tag' ? 'tags' : slug;
	var ids = select('core/editor').getEditedPostAttribute(attributeName);
...
/* harmony default export */ var terms_list_element = (Object(redux["c" /* compose */])(applySelect)(element_TaxonomiesElement));
// EXTERNAL MODULE: ./node_modules/lodash/values.js
var values = __webpack_require__(167);
...
var element_OrganizerForm = function (_Component) {
	inherits_default()(OrganizerForm, _Component);

	function OrganizerForm() {
		classCallCheck_default()(this, OrganizerForm);

		var _this = possibleConstructorReturn_default()(this, (OrganizerForm.__proto__ || Object.getPrototypeOf(OrganizerForm)).apply(this, arguments));
		...
		_this.updateOrganizer = _this.updateOrganizer.bind(_this);
	...
	createClass_default()(OrganizerForm, [{
		key: 'isCreating',
		value: function isCreating() {
			...
			if (!isFunction_default()(this.state.organizer.state)) {
				return false;
			}
		...
		key: 'updateOrganizer',
		value: function updateOrganizer(toSend) {
			var _this2 = this;

			var basePath = wp.api.getPostTypeRoute(this.props.postType);
			var request = wp.apiRequest({
				path: '/wp/v2/' + basePath,
				method: 'POST',
			...
			request.done(function (newPost) {
				if (!newPost.id) {
					console.warning('Invalid creation of organizer:', newPost);
				}

				_this2.props.addOrganizer(newPost);
		...
		key: 'isValid',
		value: function isValid() {
			var fields = values_default()(this.fields);
			var results = fields.filter(function (input) {
		...
		value: function render() {
			...
			if (this.isCreating()) {
				return [wp.element.createElement(
					...
					wp.element.createElement(
						external_var_wp_components_root_wp_components_["Placeholder"],
						{ key: 'placeholder' },
			...
			return [wp.element.createElement(
				...
				wp.element.createElement(
					...
					Object(external_var_wp_i18n_root_wp_i18n_["__"])('Create Organizer')
				),
				wp.element.createElement(
					'p',
					{
					...
					Object(external_var_wp_i18n_root_wp_i18n_["__"])('The e-mail address will be obfuscated on your site to avoid it getting harvested by spammers.', 'the-events-calendar')
				),
				wp.element.createElement(
					'dl',
					null,
					wp.element.createElement(
						'dt',
						{ onClick: this.focus('organizer[name]') },
						Object(external_var_wp_i18n_root_wp_i18n_["__"])('Name:', 'the-events-calendar'),
						' '
					),
					wp.element.createElement(
						'dd',
						null,
						wp.element.createElement(input_element, {
							type: 'text',
							ref: this.saveRef,
							name: 'organizer[name]',
							onComplete: function onComplete() {
								return _this4.setState({ isValid: _this4.isValid() });
							},
							onChange: function onChange(next) {
								return _this4.setState({ title: next.target.value });
							},
							validate: true
						})
					),
					wp.element.createElement(
						'dt',
						{ onClick: this.focus('organizer[phone]') },
						Object(external_var_wp_i18n_root_wp_i18n_["__"])('Phone:', 'the-events-calendar'),
						' '
					),
					wp.element.createElement(
						'dd',
						...
						wp.element.createElement(input_element, {
							...
							onChange: function onChange(next) {
								return _this4.setState({ phone: next.target.value });
							},
							validate: true
						})
					),
					wp.element.createElement(
						'dt',
						{ onClick: this.focus('organizer[website]') },
						Object(external_var_wp_i18n_root_wp_i18n_["__"])('Website:', 'the-events-calendar'),
						' '
					),
					wp.element.createElement(
						'dd',
						...
						wp.element.createElement(input_element, {
							...
							onChange: function onChange(next) {
								return _this4.setState({ website: next.target.value });
							},
					...
					wp.element.createElement(
						'dt',
						{ onClick: this.focus('organizer[email]') },
						Object(external_var_wp_i18n_root_wp_i18n_["__"])('Email:', 'the-events-calendar'),
						' '
					),
					wp.element.createElement(
						'dd',
						...
						wp.element.createElement(input_element, {
							...
							onChange: function onChange(next) {
								return _this4.setState({ email: next.target.value });
							},
							validate: true
						})
					)
				...
				wp.element.createElement(
					...
					Object(external_var_wp_i18n_root_wp_i18n_["__"])('Create Organizer', 'the-events-calendar')
				)
			)];
		}
	}]);
...
element_OrganizerForm.defaultProps = {
...
var pick = __webpack_require__(497);
...
var external_var_wp_editor_root_wp_editor_ = __webpack_require__(49);
...
var venue_form_style = __webpack_require__(592);
...
function toFields(venue) {
	var title = get_default()(venue, 'title', {});
	var meta = get_default()(venue, 'meta', {});
	var address = Object(utils["setDefault"])(get_default()(meta, '_VenueAddress', ''), Object(external_tribe_common_utils_globals_["editorDefaults"])().venueAddress);
	var city = Object(utils["setDefault"])(get_default()(meta, '_VenueCity', ''), Object(external_tribe_common_utils_globals_["editorDefaults"])().venueCity);
	var country = Object(utils["getVenueCountry"])(meta);
	var stateProvince = Object(utils["getVenueStateProvince"])(meta);
	var zip = Object(utils["setDefault"])(get_default()(meta, '_VenueZip', ''), Object(external_tribe_common_utils_globals_["editorDefaults"])().venueZip);
	var phone = Object(utils["setDefault"])(get_default()(meta, '_VenuePhone', ''), Object(external_tribe_common_utils_globals_["editorDefaults"])().venuePhone);
	var url = get_default()(meta, '_VenueURL', '');

	var countryCode = Object(geo_data["d" /* getCountryCode */])(country);
	return {
		title: get_default()(title, 'rendered', ''),
		address: address,
		city: city,
		country: countryCode,
		zip: zip,
...
function toVenue(fields) {
	...
	return {
		...
		meta: {
			...
			_VenueCity: city,
			_VenueCountry: get_default()(geo_data["b" /* default */].countries, country, '') || country,
			_VenueProvince: get_default()(geo_data["b" /* default */].us_states, stateProvince, '') || stateProvince,
			_VenueZip: zip,
			_VenuePhone: phone,
			_VenueURL: url,
...
var element_VenueForm = function (_Component) {
	inherits_default()(VenueForm, _Component);

	function VenueForm(props) {
		classCallCheck_default()(this, VenueForm);

		var _this = possibleConstructorReturn_default()(this, (VenueForm.__proto__ || Object.getPrototypeOf(VenueForm)).apply(this, arguments));
	...
	createClass_default()(VenueForm, [{
		key: 'componentWillUnmount',
		value: function componentWillUnmount() {
			var FIELDS = ['title', 'address', 'city', 'country', 'zip', 'phone', 'url', 'stateProvince'];
			var fields = pick_default()(this.state, FIELDS);
			fields.country = get_default()(geo_data["b" /* default */].countries, fields.country, '') || fields.country;
			fields.stateProvince = get_default()(geo_data["b" /* default */].us_states, fields.stateProvince, '') || fields.stateProvince;
			this.props.onSubmit(fields);
		}
	}, {
		key: 'renderOption',
		value: function renderOption(element) {
			return wp.element.createElement(
				'option',
				{ value: element.code, key: element.code },
				element.name
			);
		}
	}, {
		key: 'renderCountry',
		value: function renderCountry() {
			var _this2 = this;

			var country = this.state.country;

			var placeholder = country ? null : wp.element.createElement(
				'option',
				{ value: '', disabled: true },
				Object(external_var_wp_i18n_root_wp_i18n_["__"])('Country', 'the-events-calendar')
			);
			...
			return wp.element.createElement(
				'select',
				{
					...
					onChange: function onChange(event) {
						return _this2.setState({ country: event.target.value });
					}
				},
				placeholder,
				Object(geo_data["c" /* getCountries */])().map(this.renderOption)
			);
		}
	}, {
		key: 'renderState',
		value: function renderState() {
			...
			var _state = this.state,
			    stateProvince = _state.stateProvince,
			    country = _state.country;

			var states = Object(geo_data["g" /* getStates */])(country);
			...
			if (states.length === 0) {
				return wp.element.createElement(input_element, {
					...
					ref: this.saveRef,
					onChange: function onChange(event) {
						return _this3.setState({ stateProvince: event.target.value });
					},
					value: stateProvince
				});
			}
		...
		value: function render() {
			...
			return wp.element.createElement(
				...
				wp.element.createElement(external_var_wp_editor_root_wp_editor_["RichText"], {
					tagName: 'h3',
					format: 'string',
					value: title,
					onChange: function onChange(value) {
						_this4.setState({ title: value });
					},
					formattingControls: []
				}),
				wp.element.createElement(
					...
					wp.element.createElement(input_element, {
						...
						value: address,
						onChange: function onChange(next) {
							return _this4.setState({ address: next.target.value });
						}
					}),
					wp.element.createElement(input_element, {
						type: 'text',
						...
						ref: this.saveRef,
						onChange: function onChange(next) {
							return _this4.setState({ city: next.target.value });
						},
						value: city
					}),
					wp.element.createElement(
					...
					wp.element.createElement(
						...
						wp.element.createElement(input_element, {
							...
							ref: this.saveRef,
							onChange: function onChange(next) {
								return _this4.setState({ zip: next.target.value });
							},
							value: zip
						})
					),
					...
					wp.element.createElement(input_element, {
						...
						ref: this.saveRef,
						onChange: function onChange(next) {
							return _this4.setState({ url: next.target.value });
						},
						value: url
					})
				)
...
element_VenueForm.defaultProps = {
...
var _initialiseProps = function _initialiseProps() {
	...
	this.saveRef = function (input) {
		if (input) {
			...
			_this5.fields[name] = input;
		}
	};
};

/* harmony default export */ var venue_form_element = (element_VenueForm);
...
var element_MetaGroup = function (_Component) {
	inherits_default()(MetaGroup, _Component);

	function MetaGroup() {
		classCallCheck_default()(this, MetaGroup);

		return possibleConstructorReturn_default()(this, (MetaGroup.__proto__ || Object.getPrototypeOf(MetaGroup)).apply(this, arguments));
	}

	createClass_default()(MetaGroup, [{
		key: 'render',
		value: function render() {
			var _props = this.props,
			...
			var names = classnames_default()(['tribe-editor__meta-group', 'tribe-editor__meta-group--' + groupKey, className]);
			return wp.element.createElement(
				'div',
				{
					className: names,
...
element_MetaGroup.defaultProps = {
	className: '',
	children: null
};
...
var external_tribe_common_hoc_ = __webpack_require__(24);
...
var search_posts_style = __webpack_require__(593);
...
var template_SearchPosts = function (_Component) {
	inherits_default()(SearchPosts, _Component);
	...
	function SearchPosts() {
		...
		classCallCheck_default()(this, SearchPosts);

		for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
			args[_key] = arguments[_key];
		}

		return _ret = (_temp = (_this = possibleConstructorReturn_default()(this, (_ref = SearchPosts.__proto__ || Object.getPrototypeOf(SearchPosts)).call.apply(_ref, [this].concat(args))), _this), _this.renderToggle = function (_ref2) {
			var onToggle = _ref2.onToggle;
			return wp.element.createElement(external_var_wp_components_root_wp_components_["IconButton"], {
				className: 'tribe-editor__btn',
				label: _this.props.iconLabel,
				onClick: onToggle,
				icon: wp.element.createElement(external_var_wp_components_root_wp_components_["Dashicon"], { icon: 'search' })
			});
		}, _this.renderList = function (onClose) {
			var _this$props = _this.props,
						...
						wp.element.createElement(
							'button',
							{
								...
								onClick: function onClick() {
									return onItemClick(onClose)(item);
								}
							},
		...
		}, _this.renderDropdown = function (_ref3) {
			var isOpen = _ref3.isOpen,
			    onClose = _ref3.onClose;
			return wp.element.createElement(
				'div',
				{
					className: classnames_default()('tribe-editor__search-posts'),
				...
				wp.element.createElement(
					'div',
					{
						className: classnames_default()('tribe-editor__search-posts__results'),
						onScroll: _this.props.onDropdownScroll
					},
					_this.renderList(onClose)
				)
			);
		}, _temp), possibleConstructorReturn_default()(_this, _ret);
	}

	createClass_default()(SearchPosts, [{
		...
		value: function renderSearchInput() {
			...
			var instanceId = uniqueId_default()('search-');
			...
			return wp.element.createElement(
				...
				wp.element.createElement(
					'label',
					{ htmlFor: 'editor-inserter__' + instanceId, className: 'screen-reader-text' },
					searchLabel
				),
...
template_SearchPosts.propTypes = {
	name: prop_types_default.a.string.isRequired,
	postType: prop_types_default.a.string.isRequired,
	exclude: prop_types_default.a.array.isRequired,
	searchLabel: prop_types_default.a.string,
	iconLabel: prop_types_default.a.string,
	term: prop_types_default.a.string.isRequired,
	isLoading: prop_types_default.a.bool.isRequired,
	results: prop_types_default.a.array.isRequired,
	page: prop_types_default.a.number.isRequired,
	onMount: prop_types_default.a.func.isRequired,
	onInputChange: prop_types_default.a.func.isRequired,
	onItemClick: prop_types_default.a.func.isRequired,
	onDropdownScroll: prop_types_default.a.func.isRequired,
	onDropdownToggle: prop_types_default.a.func.isRequired
};
...
var element_onMount = function onMount(dispatch, ownProps) {
	return function () {
...
var element_onInputChange = function onInputChange(dispatch, ownProps) {
...
var element_onItemClick = function onItemClick(dispatch, ownProps) {
	return function (onClose) {
		return function (item) {
			var name = ownProps.name,
			    onItemSelect = ownProps.onItemSelect;
...
var element_onDropdownScroll = function onDropdownScroll(stateProps, dispatchProps, ownProps) {
	return function (event) {
		var target = event.target;
		var scrollHeight = target.scrollHeight,
		    scrollTop = target.scrollTop;

		var scrollPercentage = scrollTop / (scrollHeight - target.offsetHeight) * 100;

		if (scrollPercentage > 75) {
			var term = stateProps.term,
...
var element_onDropdownToggle = function onDropdownToggle(stateProps, dispatchProps, ownProps) {
...
var element_mapStateToProps = function mapStateToProps(state, props) {
	return {
...
var element_mapDispatchToProps = function mapDispatchToProps(dispatch, ownProps) {
	return {
		onMount: element_onMount(dispatch, ownProps),
...
var element_mergeProps = function mergeProps(stateProps, dispatchProps, ownProps) {
	return extends_default()({}, ownProps, stateProps, dispatchProps, {
		onDropdownScroll: element_onDropdownScroll(stateProps, dispatchProps, ownProps),
		onDropdownToggle: element_onDropdownToggle(stateProps, dispatchProps, ownProps)
	});
};
...
var google_map_style = __webpack_require__(594);
...
var IMAGE_FORMATS_VALUES = values_default()(IMAGE_FORMATS);
var MAP_TYPES_VALUES = values_default()(MAP_TYPES);

var API_KEY = get_default()(Object(external_tribe_common_utils_globals_["mapsAPI"])(), 'key', '');
var DEFAULT_ZOOM = parseInt(get_default()(Object(external_tribe_common_utils_globals_["mapsAPI"])(), 'zoom', 14), 10);
...
var element_GoogleMap = function (_Component) {
	inherits_default()(GoogleMap, _Component);

	function GoogleMap(props) {
		classCallCheck_default()(this, GoogleMap);

		var _this = possibleConstructorReturn_default()(this, (GoogleMap.__proto__ || Object.getPrototypeOf(GoogleMap)).apply(this, arguments));
		...
		_this.tryAgain = function () {
			...
			if (_this.tries >= _this.MAX_TRIES) {
				_this.setState({
					isLoading: false,
					error: Object(external_var_wp_i18n_root_wp_i18n_["__"])('Make sure Google Maps Library is included on this page.', 'the-events-calendar')
				});
				return;
			}
		...
		_this.attachInteractiveMap = function () {
			var interactive = _this.state.interactive;
			var interactiveMapContainer = _this.interactiveMapContainer,
			    map = _this.map;
			...
			var _google = Object(external_tribe_common_utils_globals_["google"])(),
			    maps = _google.maps;

			map.instance = new maps.Map(interactiveMapContainer.current, _this.getMapConfig());

			if (map.instance) {
				map.marker = new maps.Marker({
					position: _this.getLocation(),
					map: map.instance
				});
			}
		};

		_this.state = extends_default()({}, props, {
			error: '',
			isLoading: true,
			rendered: false
		});

		_this.interactiveMapContainer = external_React_default.a.createRef();
		_this.map = {
			instance: null,
			marker: null
		};
		_this.interval = noop_default.a;
		_this.tries = 0;
		_this.MAX_TRIES = 5;
		return _this;
	}
  ...
  */
	...
	createClass_default()(GoogleMap, [{
		...
		value: function loadMap() {
			...
			var _google2 = Object(external_tribe_common_utils_globals_["google"])(),
			    maps = _google2.maps;
			...
			if (this.invalidLocation()) {
				...
				if (isEmpty_default()(address)) {
					this.setState({
						interactive: false,
						isLoading: false,
						error: Object(external_var_wp_i18n_root_wp_i18n_["__"])('The map does not have valid coordinates nor a valid address', 'the-events-calendar')
					});
					return;
				}
		...
		value: function getMapConfig() {
			...
			var type = isArray_default()(mapType) ? mapType : [mapType];
		...
		key: 'invalidLocation',
		value: function invalidLocation() {
		...
		value: function render() {
			...
			var containerClass = classnames_default()('tribe-editor__map', {
		...
		key: 'renderMapUpdate',
		value: function renderMapUpdate() {
		...
		value: function renderMap() {
			var _state2 = this.state,
			    ...
			    error = _state2.error,
			    interactive = _state2.interactive,
			    apiKey = _state2.apiKey,
			    rendered = _state2.rendered;


			if (isLoading) {
				return wp.element.createElement(external_var_wp_components_root_wp_components_["Spinner"], null);
			}
			...
			if (!apiKey) {
				return wp.element.createElement(
					...
					null,
					' ',
					Object(external_var_wp_i18n_root_wp_i18n_["__"])('A Google Map API KEY is required to view the map', 'the-events-calendar')
				);
			}
		...
		value: function renderInteractive() {
			return wp.element.createElement(
				...
				wp.element.createElement('div', { className: 'tribe-editor__map--dynamic', ref: this.interactiveMapContainer }),
				wp.element.createElement(
					'div',
					{ className: 'trie-editor__spinner__container' },
					wp.element.createElement(external_var_wp_components_root_wp_components_["Spinner"], null)
		...
		get: function get() {
			...
			var coordinates = this.getLocation();
			var lat = coordinates.lat,
			    lng = coordinates.lng;
			...
			if (interactive) {
				...
				var invalid = this.invalidLocation();
				if (invalid && !isEmpty_default()(address)) {
		...
		get: function get() {
			var _props3 = this.props,
			    hasCenterMarker = _props3.hasCenterMarker,
			...
			var invalid = this.invalidLocation();
			var marker = invalid ? address : lat + ',' + lng;
			var markerParams = 'size:mid|color:0xff0000|label:|' + marker;
...
element_GoogleMap.RootStaticUrl = 'https://maps.googleapis.com/maps/api/staticmap';
element_GoogleMap.RootEmbedUrl = 'https://www.google.com/maps/embed/v1/place';
element_GoogleMap.ImageFormats = IMAGE_FORMATS;
element_GoogleMap.MapTypes = MAP_TYPES;
element_GoogleMap.propTypes = {
	coordinates: prop_types_default.a.object.isRequired,
	address: prop_types_default.a.string,
	size: prop_types_default.a.shape({
  ...
  */
	format: prop_types_default.a.oneOf(IMAGE_FORMATS_VALUES),

	/**
  * @see https://developers.google.com/maps/documentation/staticmaps/intro#MapTypes
  */
	mapType: prop_types_default.a.oneOf(MAP_TYPES_VALUES),

	/**
  * Add a marker on the center
  */
	hasCenterMarker: prop_types_default.a.bool,
	apiKey: prop_types_default.a.string
};
element_GoogleMap.defaultProps = {
...
/* harmony default export */ var google_map_element = (element_GoogleMap);
// EXTERNAL MODULE: ./src/modules/elements/dashboard/style.pcss
var dashboard_style = __webpack_require__(595);
 ...
 * </Dashboard
 */
var element_Dashboard = function Dashboard(_ref) {
	var className = _ref.className,
	    direction = _ref.direction,
	    isOpen = _ref.isOpen,
	    children = _ref.children;

	var containerClasses = classnames_default()('tribe-editor__dashboard__container', 'tribe-editor__dashboard__container--' + direction, { 'tribe-editor__dashboard__container--open': isOpen }, className);
...
element_Dashboard.defaultProps = {
	isOpen: false,
	className: '',
...
var month_style = __webpack_require__(629);
...
var yearsBack = 5;
var fromMonth = new Date(currentYear - yearsBack, currentMonth);
var toMonth = new Date(currentYear + 10, 11);

var element_Month = function (_Component) {
	inherits_default()(Month, _Component);

	function Month() {
		classCallCheck_default()(this, Month);

		var _this = possibleConstructorReturn_default()(this, (Month.__proto__ || Object.getPrototypeOf(Month)).apply(this, arguments));

		_this.selectDay = function (day) {
			var withRange = _this.props.withRange;

			var range = {};

			if (withRange) {
				range = DayPicker["DateUtils"].addDayToRange(day, _this.state);
				...
				if (range.to && moment_default()(range.to).isSame(range.from)) {
					range.to = undefined;
				}
			} else {
				range.from = day;
			...
			_this.setState(_this.maybeUpdate(range), function () {
				_this.onSelectCallback();
			});
		};

		_this.maybeUpdate = function (range) {
		...
		_this.onSelectCallback = function () {
			var onSelectDay = _this.props.onSelectDay;

			onSelectDay(omit_default()(_this.state, ['withRange']));
		};

		_this.getSelectedDays = function () {
			var _this$props = _this.props,
			    withRange = _this$props.withRange,
		...
		_this.getCaptionElement = function (_ref) {
			var date = _ref.date,
			    localeUtils = _ref.localeUtils;
			var _this$props2 = _this.props,
			    month = _this$props2.month,
			    setVisibleMonth = _this$props2.setVisibleMonth;


			if (date.getMonth() !== month.getMonth()) {
				return _this.renderCaption(date, localeUtils);
			}

			return wp.element.createElement(year_month_form_element, {
				today: today,
				date: date,
		...
		_this.renderCaption = function (date, localeUtils) {
			return wp.element.createElement(
				'div',
				{ className: 'tribe-editor__daypicker-caption', role: 'heading' },
				wp.element.createElement(
					'div',
					null,
	...
	createClass_default()(Month, [{
		...
		value: function render() {
			var _props = this.props,
			    ...
			    to = _props.to,
			    month = _props.month,
			    withRange = _props.withRange,
			    setVisibleMonth = _props.setVisibleMonth;

			var modifiers = withRange ? { start: from, end: to } : {};
			var containerClass = classnames_default()({ 'tribe-editor__calendars--range': withRange });
			return wp.element.createElement(DayPicker_default.a, {
				className: containerClass,
				fromMonth: fromMonth,
...
element_Month.propTypes = {
	withRange: prop_types_default.a.bool,
	onSelectDay: prop_types_default.a.func,
	from: prop_types_default.a.instanceOf(Date),
	to: prop_types_default.a.instanceOf(Date),
	month: prop_types_default.a.instanceOf(Date),
	setVisibleMonth: prop_types_default.a.func
};
element_Month.defaultProps = {
	onSelectDay: noop_default.a,
	from: today,
	to: undefined,
	month: fromMonth,
	setVisibleMonth: noop_default.a
};
/* harmony default export */ var month_element = (element_Month);
// EXTERNAL MODULE: ./src/modules/elements/search-or-create/style.pcss
var search_or_create_style = __webpack_require__(630);
...
var template_SearchOrCreate = function (_Component) {
	inherits_default()(SearchOrCreate, _Component);

	function SearchOrCreate(props) {
		classCallCheck_default()(this, SearchOrCreate);

		var _this = possibleConstructorReturn_default()(this, (SearchOrCreate.__proto__ || Object.getPrototypeOf(SearchOrCreate)).call(this, props));

		_this.renderItem = function (item) {
			var _item$title = item.title,
			    title = _item$title === undefined ? {} : _item$title,
			    id = item.id;
			var _title$rendered = title.rendered,
			    rendered = _title$rendered === undefined ? '' : _title$rendered;
			...
			return wp.element.createElement(
				...
				{
					key: id,
					onClick: _this.props.onItemClick(item)
				},
		...
		_this.renderResults = function () {
			var _this$props = _this.props,
			    ...
			    onCreateClick = _this$props.onCreateClick;


			if (!isSelected || isEmpty_default()(term)) {
				return null;
			}
	...
	createClass_default()(SearchOrCreate, [{
		key: 'componentDidMount',
		value: function componentDidMount() {
			var _props = this.props,
			    addBlock = _props.addBlock,
			    setSearchPostType = _props.setSearchPostType,
			    name = _props.name,
		...
		value: function render() {
			...
			var containerClass = classnames_default()('tribe-editor__soc__input__container', { 'tribe-editor__soc__input__container--active': isSelected });
...
template_SearchOrCreate.defaultProps = {
	isSelected: false,
	term: '',
	placeholder: Object(external_var_wp_i18n_root_wp_i18n_["__"])('Add or Find', 'the-events-calendar'),
	name: '',
	icon: null,
	posts: [],
	isLoading: false,
	clearBlock: noop_default.a,
	setFocus: noop_default.a,
	onInputChange: noop_default.a,
	onCreateClick: noop_default.a,
	onItemClick: noop_default.a
};
template_SearchOrCreate.propTypes = {
	isSelected: prop_types["PropTypes"].bool,
	term: prop_types["PropTypes"].string,
	placeholder: prop_types["PropTypes"].string,
	name: prop_types["PropTypes"].string,
	icon: prop_types["PropTypes"].object,
	posts: prop_types["PropTypes"].array,
	isLoading: prop_types["PropTypes"].bool,
	clearBlock: prop_types["PropTypes"].func,
	setFocus: prop_types["PropTypes"].func,
	onInputChange: prop_types["PropTypes"].func,
	onCreateClick: prop_types["PropTypes"].func,
	onItemClick: prop_types["PropTypes"].func
};
...
var setFocus = function setFocus(isSelected) {
	return function (inputRef) {
...
var search_or_create_element_onInputChange = function onInputChange(dispatchProps, ownProps) {
	return function (event) {
		var setTerm = dispatchProps.setTerm,
		    search = dispatchProps.search;
		var name = ownProps.name,
		    exclude = ownProps.exclude;
		var value = event.target.value;
...
var element_onCreateClick = function onCreateClick(term, onCreateNew) {
	return function () {
		return onCreateNew(term);
	};
};

var search_or_create_element_onItemClick = function onItemClick(dispatchProps, ownProps) {
	return function (item) {
		return function () {
			var clearBlock = dispatchProps.clearBlock;
			var name = ownProps.name,
			    onItemSelect = ownProps.onItemSelect;
...
var search_or_create_element_mapStateToProps = function mapStateToProps(state, props) {
	return {
		term: search["c" /* selectors */].getSearchTerm(state, props),
		isLoading: search["c" /* selectors */].getIsLoading(state, props),
...
var search_or_create_element_mapDispatchToProps = function mapDispatchToProps(dispatch) {
	return extends_default()({}, Object(redux["a" /* bindActionCreators */])(search["a" /* actions */], dispatch), Object(redux["a" /* bindActionCreators */])(search["d" /* thunks */], dispatch));
};

var search_or_create_element_mergeProps = function mergeProps(stateProps, dispatchProps, ownProps) {
	return extends_default()({}, ownProps, stateProps, dispatchProps, {
...
/* harmony default export */ var search_or_create_element = (Object(es["a" /* connect */])(search_or_create_element_mapStateToProps, search_or_create_element_mapDispatchToProps, search_or_create_element_mergeProps)(search_or_create_template));
// EXTERNAL MODULE: ./src/modules/elements/loading/style.pcss
var loading_style = __webpack_require__(631);
...
/* harmony default export */ var loading = (function (_ref) {
	var className = _ref.className;

	return wp.element.createElement(
		'span',
		{ className: classnames_default()(['tribe-editor__spinner-container', className]) },
		wp.element.createElement(external_var_wp_components_root_wp_components_["Spinner"], null)
	);
});
// EXTERNAL MODULE: ./src/modules/elements/year-month-form/style.pcss
var year_month_form_style = __webpack_require__(632);
...
var YearMonthForm = function YearMonthForm(_ref) {
	...
	for (var i = currentYear - yearsBack; i <= toMonth.getFullYear(); i++) {
		years.push(i);
	}
	...
	return wp.element.createElement(
		...
		wp.element.createElement(
			...
			months.map(function (month, monthNum) {
				if (date.getFullYear() === currentYear - yearsBack && monthNum < currentMonth) {
					return wp.element.createElement(
						'option',
						{ key: month, value: monthNum, disabled: true },
						month
					);
				}
...
var upsell_style = __webpack_require__(633);
...
var element_Upsell = function Upsell() {
	return wp.element.createElement(
		'div',
		...
		wp.element.createElement(
			...
			Object(external_var_wp_i18n_root_wp_i18n_["__"])('Turbocharge your events with our premium calendar and ticketing add-ons. ', 'the-events-calendar'),
			wp.element.createElement(
				'a',
				{
				...
				Object(external_var_wp_i18n_root_wp_i18n_["_x"])('Check \'em out!', 'linked text for plugin add-ons', 'the-events-calendar')
			)
		)
	);
};

/* harmony default export */ var upsell_element = (element_Upsell);
// EXTERNAL MODULE: ./node_modules/react-input-autosize/lib/AutosizeInput.js
var AutosizeInput = __webpack_require__(140);
...
var timezone_style = __webpack_require__(634);
...
var element_Timezone = function Timezone(_ref) {
	var value = _ref.value,
	    placeholder = _ref.placeholder,
	    className = _ref.className,
	    onChange = _ref.onChange;
	return wp.element.createElement(AutosizeInput_default.a, {
		className: className,
		value: value,
		placeholder: placeholder,
...
/* harmony default export */ var timezone_element = (element_Timezone);
// EXTERNAL MODULE: ./src/modules/elements/edit-link/style.pcss
var edit_link_style = __webpack_require__(635);
...
var element_EditLink = function EditLink(_ref) {
	var postId = _ref.postId,
	    label = _ref.label,
	    target = _ref.target;

	var admin = get_default()(external_tribe_common_utils_["globals"].common(), 'adminUrl', '');
	if (!admin || !postId) {
		return null;
	}
...
element_EditLink.propTypes = {
	postId: prop_types_default.a.number,
	label: prop_types_default.a.string,
	target: prop_types_default.a.string
};

element_EditLink.defaultProps = {
	postId: 0,
	label: Object(external_var_wp_i18n_root_wp_i18n_["__"])('Edit', 'the-events-calendar'),
	target: '_blank'
};

/* harmony default export */ var edit_link_element = (element_EditLink);
// CONCATENATED MODULE: ./src/modules/elements/index.js
/* concated harmony reexport Input */__webpack_require__.d(__webpack_exports__, "Input", function() { return input_element; });
/* concated harmony reexport TermsList */__webpack_require__.d(__webpack_exports__, "TermsList", function() { return terms_list_element; });
/* concated harmony reexport OrganizerForm */__webpack_require__.d(__webpack_exports__, "OrganizerForm", function() { return organizer_form_element; });
/* concated harmony reexport VenueForm */__webpack_require__.d(__webpack_exports__, "VenueForm", function() { return venue_form_element; });
/* concated harmony reexport toFields */__webpack_require__.d(__webpack_exports__, "toFields", function() { return toFields; });
/* concated harmony reexport toVenue */__webpack_require__.d(__webpack_exports__, "toVenue", function() { return toVenue; });
/* concated harmony reexport MetaGroup */__webpack_require__.d(__webpack_exports__, "MetaGroup", function() { return meta_group_element; });
/* concated harmony reexport SearchPosts */__webpack_require__.d(__webpack_exports__, "SearchPosts", function() { return search_posts_element; });
/* concated harmony reexport GoogleMap */__webpack_require__.d(__webpack_exports__, "GoogleMap", function() { return google_map_element; });
/* concated harmony reexport Dashboard */__webpack_require__.d(__webpack_exports__, "Dashboard", function() { return dashboard_element; });
/* concated harmony reexport Month */__webpack_require__.d(__webpack_exports__, "Month", function() { return month_element; });
/* concated harmony reexport SearchOrCreate */__webpack_require__.d(__webpack_exports__, "SearchOrCreate", function() { return search_or_create_element; });
/* concated harmony reexport Loading */__webpack_require__.d(__webpack_exports__, "Loading", function() { return loading; });
/* concated harmony reexport YearMonthForm */__webpack_require__.d(__webpack_exports__, "YearMonthForm", function() { return year_month_form_element; });
/* concated harmony reexport Upsell */__webpack_require__.d(__webpack_exports__, "Upsell", function() { return upsell_element; });
/* concated harmony reexport TimeZone */__webpack_require__.d(__webpack_exports__, "TimeZone", function() { return timezone_element; });
/* concated harmony reexport EditLink */__webpack_require__.d(__webpack_exports__, "EditLink", function() { return edit_link_element; });
...
var _toDate = __webpack_require__(403);

var _toDate2 = _interopRequireDefault(_toDate);

var _toFloat = __webpack_require__(473);

var _toFloat2 = _interopRequireDefault(_toFloat);

var _toInt = __webpack_require__(529);

var _toInt2 = _interopRequireDefault(_toInt);

var _toBoolean = __webpack_require__(530);

var _toBoolean2 = _interopRequireDefault(_toBoolean);

var _equals = __webpack_require__(531);
...
var _matches = __webpack_require__(533);

var _matches2 = _interopRequireDefault(_matches);

var _isEmail = __webpack_require__(534);

var _isEmail2 = _interopRequireDefault(_isEmail);

var _isURL = __webpack_require__(535);

var _isURL2 = _interopRequireDefault(_isURL);

var _isMACAddress = __webpack_require__(536);

var _isMACAddress2 = _interopRequireDefault(_isMACAddress);

var _isIP = __webpack_require__(475);

var _isIP2 = _interopRequireDefault(_isIP);

var _isFQDN = __webpack_require__(405);

var _isFQDN2 = _interopRequireDefault(_isFQDN);

var _isBoolean = __webpack_require__(537);

var _isBoolean2 = _interopRequireDefault(_isBoolean);

var _isAlpha = __webpack_require__(538);

var _isAlpha2 = _interopRequireDefault(_isAlpha);

var _isAlphanumeric = __webpack_require__(539);

var _isAlphanumeric2 = _interopRequireDefault(_isAlphanumeric);

var _isNumeric = __webpack_require__(540);

var _isNumeric2 = _interopRequireDefault(_isNumeric);

var _isPort = __webpack_require__(541);

var _isPort2 = _interopRequireDefault(_isPort);

var _isLowercase = __webpack_require__(542);

var _isLowercase2 = _interopRequireDefault(_isLowercase);

var _isUppercase = __webpack_require__(543);

var _isUppercase2 = _interopRequireDefault(_isUppercase);

var _isAscii = __webpack_require__(544);

var _isAscii2 = _interopRequireDefault(_isAscii);

var _isFullWidth = __webpack_require__(477);

var _isFullWidth2 = _interopRequireDefault(_isFullWidth);

var _isHalfWidth = __webpack_require__(478);

var _isHalfWidth2 = _interopRequireDefault(_isHalfWidth);

var _isVariableWidth = __webpack_require__(545);

var _isVariableWidth2 = _interopRequireDefault(_isVariableWidth);

var _isMultibyte = __webpack_require__(546);

var _isMultibyte2 = _interopRequireDefault(_isMultibyte);

var _isSurrogatePair = __webpack_require__(547);

var _isSurrogatePair2 = _interopRequireDefault(_isSurrogatePair);

var _isInt = __webpack_require__(476);

var _isInt2 = _interopRequireDefault(_isInt);

var _isFloat = __webpack_require__(548);

var _isFloat2 = _interopRequireDefault(_isFloat);

var _isDecimal = __webpack_require__(549);

var _isDecimal2 = _interopRequireDefault(_isDecimal);

var _isHexadecimal = __webpack_require__(479);

var _isHexadecimal2 = _interopRequireDefault(_isHexadecimal);

var _isDivisibleBy = __webpack_require__(550);

var _isDivisibleBy2 = _interopRequireDefault(_isDivisibleBy);

var _isHexColor = __webpack_require__(551);

var _isHexColor2 = _interopRequireDefault(_isHexColor);

var _isISRC = __webpack_require__(552);

var _isISRC2 = _interopRequireDefault(_isISRC);

var _isMD = __webpack_require__(553);

var _isMD2 = _interopRequireDefault(_isMD);

var _isHash = __webpack_require__(554);

var _isHash2 = _interopRequireDefault(_isHash);

var _isJSON = __webpack_require__(555);

var _isJSON2 = _interopRequireDefault(_isJSON);

var _isEmpty = __webpack_require__(556);

var _isEmpty2 = _interopRequireDefault(_isEmpty);

var _isLength = __webpack_require__(557);
...
var _isUUID = __webpack_require__(558);

var _isUUID2 = _interopRequireDefault(_isUUID);

var _isMongoId = __webpack_require__(559);

var _isMongoId2 = _interopRequireDefault(_isMongoId);

var _isAfter = __webpack_require__(560);

var _isAfter2 = _interopRequireDefault(_isAfter);

var _isBefore = __webpack_require__(561);

var _isBefore2 = _interopRequireDefault(_isBefore);

var _isIn = __webpack_require__(562);

var _isIn2 = _interopRequireDefault(_isIn);

var _isCreditCard = __webpack_require__(563);

var _isCreditCard2 = _interopRequireDefault(_isCreditCard);

var _isISIN = __webpack_require__(564);

var _isISIN2 = _interopRequireDefault(_isISIN);

var _isISBN = __webpack_require__(565);

var _isISBN2 = _interopRequireDefault(_isISBN);

var _isISSN = __webpack_require__(566);

var _isISSN2 = _interopRequireDefault(_isISSN);

var _isMobilePhone = __webpack_require__(567);

var _isMobilePhone2 = _interopRequireDefault(_isMobilePhone);

var _isCurrency = __webpack_require__(568);

var _isCurrency2 = _interopRequireDefault(_isCurrency);

var _isISO = __webpack_require__(569);

var _isISO2 = _interopRequireDefault(_isISO);

var _isISO31661Alpha = __webpack_require__(570);

var _isISO31661Alpha2 = _interopRequireDefault(_isISO31661Alpha);

var _isBase = __webpack_require__(571);

var _isBase2 = _interopRequireDefault(_isBase);

var _isDataURI = __webpack_require__(572);

var _isDataURI2 = _interopRequireDefault(_isDataURI);

var _isMimeType = __webpack_require__(573);

var _isMimeType2 = _interopRequireDefault(_isMimeType);

var _isLatLong = __webpack_require__(574);

var _isLatLong2 = _interopRequireDefault(_isLatLong);

var _isPostalCode = __webpack_require__(575);

var _isPostalCode2 = _interopRequireDefault(_isPostalCode);

var _ltrim = __webpack_require__(480);

var _ltrim2 = _interopRequireDefault(_ltrim);

var _rtrim = __webpack_require__(481);

var _rtrim2 = _interopRequireDefault(_rtrim);

var _trim = __webpack_require__(576);

var _trim2 = _interopRequireDefault(_trim);

var _escape = __webpack_require__(577);

var _escape2 = _interopRequireDefault(_escape);

var _unescape = __webpack_require__(578);

var _unescape2 = _interopRequireDefault(_unescape);

var _stripLow = __webpack_require__(579);

var _stripLow2 = _interopRequireDefault(_stripLow);

var _whitelist = __webpack_require__(580);

var _whitelist2 = _interopRequireDefault(_whitelist);

var _blacklist = __webpack_require__(482);

var _blacklist2 = _interopRequireDefault(_blacklist);

var _isWhitelisted = __webpack_require__(581);

var _isWhitelisted2 = _interopRequireDefault(_isWhitelisted);

var _normalizeEmail = __webpack_require__(582);

var _normalizeEmail2 = _interopRequireDefault(_normalizeEmail);

var _toString = __webpack_require__(404);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(72)(module), __webpack_require__(99)))
...
var assignValue = __webpack_require__(409),
...
var _DateUtils = __webpack_require__(137);
